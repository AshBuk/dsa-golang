...
<img src="ALgoDSgo.png" alt="AlgoDSgo Logo" width="150" align="right">

Algorithms & Data Structures in Go | Search, Sort, Interview Exercises | Educational Repository

Educational focus on classic fundamental algorithms and data structures, with walkthroughs in complex areas, in Go.

Written during the learning process as a help for learners. Emphasis on clean, understandable code and semantic naming, without overcomplication, with an attempt to convey the fundamental CS understanding.
